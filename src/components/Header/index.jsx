...
export default function Header() {
  ...
  const lengthOfProducts = selectedProducts.length
              ...
              <div className="col-xl-2 col-lg-6 col-md-6 col-5 col-sm-7 pl-0">
                <div className="header-right f-right">
                  <ul>
                    ...
                    <li className="d-shop-cart"><a href="#"><i className="fas fa-shopping-cart"></i> <span className="cart-count">{lengthOfProducts}</span></a>
                      <ul className="minicart">
                        {
                          selectedProducts.length > 0 && selectedProducts.map(elm => (
                            <li>
